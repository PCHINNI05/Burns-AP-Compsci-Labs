package Lab2;
public class Samsung extends TVs {
	public String model; 
	public static final String brand = "Samsung ";
	
	public Samsung (double weight, double cost, String model, String deviceName, double screenSize, int hdmiPortCount, boolean aiCompatible) {
