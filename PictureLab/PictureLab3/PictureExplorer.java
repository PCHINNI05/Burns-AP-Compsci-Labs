...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
	  /* Original
	Picture pix = new Picture("C:\\Users\\prane\\eclipse-workspace\\Required Labs\\Images\\beach.jpg");
	pix.explore();
	  */
	  
	  /* Excercise 1
	Picture pix = new Picture("C:\Users\prane\eclipse-workspace\Required Labs\Images\femaleLionAndHall.jpg");
	pix.explore();
	  */
	  
	  // Excercise 2
	Picture pix = new Picture("C:\\Users\\prane\\eclipse-workspace\\Required Labs\\Images\\ghrek.jpg");
	Picture pixResize = pix.scale(.25, .25);
	pixResize.write("C:\\Users\\prane\\eclipse-workspace\\Required Labs\\Images\\ghrek.jpg");
	pixResize.explore();
  }
}